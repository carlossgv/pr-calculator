...
export const es = {
  ...
  prefs: {
    ...
    install: {
      ...
      installedHint: "PR Calc ya está instalado en este dispositivo.",
      iosTitle: "Instalar en iPhone o iPad",
      iosHint: "Abre en Safari, toca Compartir y luego Añadir a inicio.",
      androidTitle: "Instalar en Android",
      androidHint: "Toca el menú (⋮) y elige Instalar app.",
      desktopTitle: "Instalar en escritorio",
      desktopHint: "Usa el menú del navegador y elige Instalar app.",
      promptHint: "Toca Instalar para añadir PR Calc al dispositivo.",
      installCta: "Instalar",
      installAria: "Instalar PR Calc",
    },
  },
  movements: {
