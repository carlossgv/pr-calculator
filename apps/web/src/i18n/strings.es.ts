...
export const es = {
  ...
  planner: {
    ...
    open: "Preparar entrenamiento",
    back: "Volver",
    baseWeight: "Peso al 100%",
    percentages: "Porcentajes del entrenamiento",
    orderHint: "En el orden del entrenamiento",
    percentageInput: "Porcentaje",
    percentagePlaceholder: "Agregar porcentaje, ej. 75",
    addPercentage: "Agregar porcentaje",
    invalidPercentage: "Ingresa un porcentaje único entre 0.1 y 300.",
    removePercentage: "Quitar porcentaje",
    moveUp: "Mover antes",
    moveDown: "Mover después",
    planResults: "Plan de carga del entrenamiento",
    showDiagram: "Mostrar diagrama de discos",
    diagramTitle: "Diagrama de discos",
    target: "Peso objetivo",
    loadable: "Peso cargable",
    platesPerSide: "Discos por lado",
    barOnly: "Solo barra",
    add: "Agregar por lado",
    remove: "Quitar por lado",
    noChange: "Sin cambio de discos",
    emptyPlan:
      "Aún no hay porcentajes. Agrega uno arriba para crear tu plan de entrenamiento.",
    inventoryTitle: "Inventario de discos requerido",
    inventoryHint:
      "Mínimo total de discos necesarios junto a una barra para esta secuencia. No se verifica la disponibilidad.",
  },
  common: {
    close: "Cerrar",
  },
  ...
  prefs: {
    recovery: {
      ...
      create: "Crear ID de recuperación",
      connect: "Conectar ID de recuperación existente",
      recoveryId: "ID de recuperación",
      password: "Contraseña",
      confirmPassword: "Confirmar contraseña",
      save: "Guardar credenciales",
      changeId: "Cambiar ID de recuperación",
      changePassword: "Cambiar contraseña",
      copy: "Copiar ID de recuperación",
      invalidId: "Usa 3–30 letras, números, guiones o guiones bajos.",
      passwordLength: "La contraseña debe tener entre 8 y 128 caracteres.",
      passwordMismatch: "Las contraseñas no coinciden.",
      invalidLogin: "ID de recuperación o contraseña inválidos",
      unavailable: "Ese ID de recuperación no está disponible.",
      replacementTitle: "¿Reemplazar datos locales?",
      replacementWarning: "Este dispositivo tiene movimientos o marcas. Expórtalos primero, reemplázalos o cancela.",
      exportFirst: "Exportar backup local",
      replace: "Reemplazar datos locales",
      cancel: "Cancelar",
      finishingRestore: "Terminando la restauración",
      busy: "Guardando…",
    },
