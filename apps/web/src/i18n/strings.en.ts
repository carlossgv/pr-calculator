...
export const en = {
  ...
  prefs: {
    ...
    install: {
      ...
      installedHint: "PR Calc is already installed on this device.",
      iosTitle: "Install on iPhone or iPad",
      iosHint: "Open in Safari, tap Share, then Add to Home Screen.",
      androidTitle: "Install on Android",
      androidHint: "Tap the menu (⋮) and choose Install app.",
      desktopTitle: "Install on desktop",
      desktopHint: "Use your browser menu and choose Install app.",
      promptHint: "Tap Install to add PR Calc to your device.",
      installCta: "Install",
      installAria: "Install PR Calc",
    },
  },
  movements: {
